...
ntickets=function(N, gamma, p){
  ...
  plot(N:(nd+20), binomfind(N=N, gamma=gamma, p=p, nd=N:(nd+20)), type="b", xlab="n", ylab="Objective", pch=19, main="Objective function to find n using binomial distribution")
  abline(h=0, v=nd)
